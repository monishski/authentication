...
router.post("/refresh_token", [validate_access_token_1.validate_access_token, validate_refresh_token_1.validate_refresh_token], refresh_token_1.controller_post_refresh_token);
router.post("/signin", signin_1.controller_post_signin); //The errors will be generic messages!
router.post("/signup", [validate_signup_1.validateEmail, validate_signup_1.validatePassword, validate_signup_1.validateConfirmPassword, validate_request_1.validateRequest], signup_1.controller_post_signup); //The errors below are per field!
