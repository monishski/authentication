...
export const Input = ({
  ...
  if (!inputIsValid && inputIsTouched) {
    ...
    formInputIcon = <SvgCross className="form-input__icon form-input__icon--error"></SvgCross>
  } else if (inputIsValid && inputIsTouched) {
    css_formInputFieldError = "form-input__field--success"
    formInputIcon = <SvgTick className="form-input__icon form-input__icon--success"></SvgTick>
  }
